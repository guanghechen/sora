...
export interface IObservableCollection<K, V, C extends IImmutableCollection<K, V>>
...
export interface IObservableMap<K, V, C extends IImmutableMap<K, V>>
...
export interface IObservableSet<V, C extends IImmutableSet<V>>
